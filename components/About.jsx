        ...
        <div className="grid lg:grid-cols-5 mt-10 sm:mt-20 mb-20 lg:mb-0 w-full lg:h-[510px]">
          ...
          <div className="lg:col-span-2 w-full h-full">
            <img
              ...
              alt="Profile"
              className="max-w-[420px] h-full object-cover mx-auto"
            />
          </div>

          <div className="lg:col-span-3 w-full h-auto md:px-10 mt-10 lg:mt-0">
            <motion.p
              variants={fadeIn("", "", 1, 1)}
            ...
            <motion.p
              variants={fadeIn("", "", 1, 1)}
              className="mt-4 text-white text-3xl font-bold leading-[45px]"
            >
            ...
            <div className="flex mt-8 items-center">
              ...
              <div className="flex items-center space-x-4">
                <div className="h-[1px] w-full bg-gray-500 mx-4" />

                <a href="https://www.linkedin.com/in/musfiqur-rahman-8b8193265/" target="new" 
                className="group relative">
                  <img src="/linkedIn.svg" alt="Linkedin" className="size-20" />
                ...
                <a href="https://github.com/n4f1s" target="new" className="group relative">
                  <img src="/github.svg" alt="GitHub" className="size-20" />
